...
const features = [
  ...
  },
  {
    ...
    description: 'Stay protected with quick access to fire extinguishers and sprinklers for ultimate safety..',
  },
  {
    icon: BellElectric,
    title: 'Fire Alarm Alerts',
    description: 'Get instant app-only notifications for fire emergencies and safety tips.',
  },
];
  ...
  return (
    <div className="min-h-screen">
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold">FireInTheHole</h1>
      </header>
            ...
            <div className="md:w-1/2 mb-8 md:mb-0">
              <MotionWrapper>
                <h2 className="text-4xl md:text-6xl font-bold mb-4">
                  Di bali nang Manakawan huwag lang Masunugan
                </h2>
              </MotionWrapper>
              <MotionWrapper delay={0.2}>
                <p className="text-xl mb-6">
                  A mobile app that can save your life and probably others too
                </p>
              </MotionWrapper>
      ...
      <footer className="bg-[#1BC464] text-white">
        <Link
          href="https://youtu.be/digNlTGuWGo"
          target="_blank"
